...
public class RawOrganizationDetailsClient {
    protected final ClientOptions clientOptions;

    public RawOrganizationDetailsClient(ClientOptions clientOptions) {
     ...
     * Retrieve details for this Organization, including display name and branding options. To learn more about Auth0 Organizations, read <a href="https://auth0.com/docs/manage-users/organizations">Organizations</a>.
     */
    public MyOrganizationApiHttpResponse<OrgDetailsRead> get(RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MyOrganizationApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, OrgDetailsRead.class), response);
            }
            try {
     ...
     */
    public MyOrganizationApiHttpResponse<OrgDetailsRead> update() {
     ...
     * Update details for this Organization, such as display name and branding options. To learn more about Auth0 Organizations, read <a href="https://auth0.com/docs/manage-users/organizations">Organizations</a>.
     */
    public MyOrganizationApiHttpResponse<OrgDetailsRead> update(RequestOptions requestOptions) {
     ...
     * Update details for this Organization, such as display name and branding options. To learn more about Auth0 Organizations, read <a href="https://auth0.com/docs/manage-users/organizations">Organizations</a>.
     */
    public MyOrganizationApiHttpResponse<OrgDetailsRead> update(OrgDetails request) {
     ...
     * Update details for this Organization, such as display name and branding options. To learn more about Auth0 Organizations, read <a href="https://auth0.com/docs/manage-users/organizations">Organizations</a>.
     */
    public MyOrganizationApiHttpResponse<OrgDetailsRead> update(OrgDetails request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("details");
        if (requestOptions != null) {
