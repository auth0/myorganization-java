...
public class MyOrganizationApiBuilder {
     ...
     * Sets token
     */
    public MyOrganizationApiBuilder token(String token) {
        this.token = token;
        return this;
    }

    public MyOrganizationApiBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public MyOrganizationApiBuilder url(String url) {
     ...
     */
    public MyOrganizationApiBuilder timeout(int timeout) {
     ...
     */
    public MyOrganizationApiBuilder maxRetries(int maxRetries) {
     ...
     */
    public MyOrganizationApiBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public MyOrganizationApiBuilder logging(LogConfig logging) {
     ...
     */
    public MyOrganizationApiBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public MyOrganizationApiBuilder tenantDomain(String tenantDomain) {
    ...
    public MyOrganizationApi build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new MyOrganizationApi(buildClientOptions());
    }
}
