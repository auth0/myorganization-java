...
public final class IdpOidcRequest {
    ...
    private final IdpOidcOptionsRequest options;
    ...
    public IdpOidcOptionsRequest getOptions() {
        return options;
    }
    ...
    public interface StrategyStage {
        OptionsStage strategy(@NotNull IdpOidcRequestStrategy strategy);
    ...
    public interface OptionsStage {
         ...
         */
        NameStage options(@NotNull IdpOidcOptionsRequest options);
    }
    ...
    public static final class Builder implements StrategyStage, OptionsStage, NameStage, _FinalStage {
        ...
        private IdpOidcOptionsRequest options;
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public OptionsStage strategy(@NotNull IdpOidcRequestStrategy strategy) {
        ...
        @java.lang.Override
        @JsonSetter("options")
        public NameStage options(@NotNull IdpOidcOptionsRequest options) {
