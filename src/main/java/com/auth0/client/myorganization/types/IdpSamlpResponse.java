...
@JsonDeserialize(builder = IdpSamlpResponse.Builder.class)
public final class IdpSamlpResponse {
    private final IdpSamlpResponseStrategy strategy;

    private final Optional<IdpSamlpOptionsResponse> options;
    ...
    private IdpSamlpResponse(
            IdpSamlpResponseStrategy strategy,
            Optional<IdpSamlpOptionsResponse> options,
    ...
    public IdpSamlpResponseStrategy getStrategy() {
        return strategy;
    }
    ...
    public Optional<IdpSamlpOptionsResponse> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpSamlpResponse && equalTo((IdpSamlpResponse) other);
    }
    ...
    private boolean equalTo(IdpSamlpResponse other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull IdpSamlpResponseStrategy strategy);

        Builder from(IdpSamlpResponse other);
    }

    public interface _FinalStage {
        IdpSamlpResponse build();
         ...
         */
        _FinalStage options(Optional<IdpSamlpOptionsResponse> options);

        _FinalStage options(IdpSamlpOptionsResponse options);
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private IdpSamlpResponseStrategy strategy;
        ...
        private Optional<IdpSamlpOptionsResponse> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(IdpSamlpResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull IdpSamlpResponseStrategy strategy) {
         ...
         */
        @java.lang.Override
        public _FinalStage options(IdpSamlpOptionsResponse options) {
        ...
        public _FinalStage options(Optional<IdpSamlpOptionsResponse> options) {
            this.options = options;
            return this;
        }

        @java.lang.Override
        public IdpSamlpResponse build() {
            return new IdpSamlpResponse(
                    strategy,
                    options,
                    attributes,
                    id,
