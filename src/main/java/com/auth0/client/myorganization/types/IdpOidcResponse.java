...
@JsonDeserialize(builder = IdpOidcResponse.Builder.class)
public final class IdpOidcResponse {
    private final IdpOidcResponseStrategy strategy;

    private final Optional<IdpOidcOptionsResponse> options;
    ...
    private IdpOidcResponse(
            IdpOidcResponseStrategy strategy,
            Optional<IdpOidcOptionsResponse> options,
    ...
    public IdpOidcResponseStrategy getStrategy() {
        return strategy;
    }
    ...
    public Optional<IdpOidcOptionsResponse> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpOidcResponse && equalTo((IdpOidcResponse) other);
    }
    ...
    private boolean equalTo(IdpOidcResponse other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull IdpOidcResponseStrategy strategy);

        Builder from(IdpOidcResponse other);
    }

    public interface _FinalStage {
        IdpOidcResponse build();
         ...
         */
        _FinalStage options(Optional<IdpOidcOptionsResponse> options);

        _FinalStage options(IdpOidcOptionsResponse options);
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private IdpOidcResponseStrategy strategy;
        ...
        private Optional<IdpOidcOptionsResponse> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(IdpOidcResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull IdpOidcResponseStrategy strategy) {
         ...
         */
        @java.lang.Override
        public _FinalStage options(IdpOidcOptionsResponse options) {
        ...
        public _FinalStage options(Optional<IdpOidcOptionsResponse> options) {
            this.options = options;
            return this;
        }

        @java.lang.Override
        public IdpOidcResponse build() {
            return new IdpOidcResponse(
                    strategy,
                    options,
                    attributes,
                    id,
