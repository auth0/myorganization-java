...
@JsonDeserialize(builder = IdpOktaResponse.Builder.class)
public final class IdpOktaResponse {
    ...
    public IdpOktaResponseStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpOktaResponse && equalTo((IdpOktaResponse) other);
    }
    ...
    private boolean equalTo(IdpOktaResponse other) {
    ...
    public static final class Builder implements StrategyStage, OptionsStage, _FinalStage {
        ...
        @Override
        public Builder from(IdpOktaResponse other) {
        ...
        @Override
        public IdpOktaResponse build() {
            return new IdpOktaResponse(
                    strategy,
                    options,
                    attributes,
                    id,
