...
@JsonDeserialize(builder = IdpOktaRequest.Builder.class)
public final class IdpOktaRequest {
    private final IdpOktaRequestStrategy strategy;

    private final IdpOktaOptionsRequest options;
    ...
    private IdpOktaRequest(
            IdpOktaRequestStrategy strategy,
            IdpOktaOptionsRequest options,
            Optional<String> id,
            String name,
    ...
    public IdpOktaRequestStrategy getStrategy() {
        return strategy;
    }
    ...
    public IdpOktaOptionsRequest getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpOktaRequest && equalTo((IdpOktaRequest) other);
    }
    ...
    private boolean equalTo(IdpOktaRequest other) {
    ...
    public interface StrategyStage {
        OptionsStage strategy(@NotNull IdpOktaRequestStrategy strategy);

        Builder from(IdpOktaRequest other);
    }
    ...
    public interface OptionsStage {
         ...
         */
        NameStage options(@NotNull IdpOktaOptionsRequest options);
    }
    ...
    public static final class Builder implements StrategyStage, OptionsStage, NameStage, _FinalStage {
        private IdpOktaRequestStrategy strategy;

        private IdpOktaOptionsRequest options;
        ...
        @java.lang.Override
        public Builder from(IdpOktaRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public OptionsStage strategy(@NotNull IdpOktaRequestStrategy strategy) {
        ...
        @java.lang.Override
        @JsonSetter("options")
        public NameStage options(@NotNull IdpOktaOptionsRequest options) {
        ...
        @java.lang.Override
        public IdpOktaRequest build() {
            return new IdpOktaRequest(
                    strategy,
                    options,
                    id,
                    name,
