...
public final class IdpAdfsResponse {
    ...
    private final IdpAdfsOptionsResponse options;
    ...
    private IdpAdfsResponse(
            ...
            IdpAdfsOptionsResponse options,
            Optional<String> id,
    ...
    public IdpAdfsOptionsResponse getOptions() {
        return options;
    }
    ...
    public interface StrategyStage {
        OptionsStage strategy(@NotNull IdpAdfsResponseStrategy strategy);
    ...
    public interface OptionsStage {
         ...
         */
        _FinalStage options(@NotNull IdpAdfsOptionsResponse options);
    }
    ...
    public static final class Builder implements StrategyStage, OptionsStage, _FinalStage {
        ...
        private IdpAdfsOptionsResponse options;
        ...
        @Override
        @JsonSetter("strategy")
        public OptionsStage strategy(@NotNull IdpAdfsResponseStrategy strategy) {
        ...
        @Override
        @JsonSetter("options")
        public _FinalStage options(@NotNull IdpAdfsOptionsResponse options) {
