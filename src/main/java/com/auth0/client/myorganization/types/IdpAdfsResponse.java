...
@JsonDeserialize(builder = IdpAdfsResponse.Builder.class)
public final class IdpAdfsResponse {
    private final IdpAdfsResponseStrategy strategy;

    private final Optional<IdpAdfsOptionsResponse> options;
    ...
    private IdpAdfsResponse(
            IdpAdfsResponseStrategy strategy,
            Optional<IdpAdfsOptionsResponse> options,
            Optional<String> id,
    ...
    public IdpAdfsResponseStrategy getStrategy() {
        return strategy;
    }
    ...
    public Optional<IdpAdfsOptionsResponse> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpAdfsResponse && equalTo((IdpAdfsResponse) other);
    }
    ...
    private boolean equalTo(IdpAdfsResponse other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull IdpAdfsResponseStrategy strategy);

        Builder from(IdpAdfsResponse other);
    }

    public interface _FinalStage {
        IdpAdfsResponse build();
         ...
         */
        _FinalStage options(Optional<IdpAdfsOptionsResponse> options);

        _FinalStage options(IdpAdfsOptionsResponse options);
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private IdpAdfsResponseStrategy strategy;
        ...
        private Optional<IdpAdfsOptionsResponse> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(IdpAdfsResponse other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull IdpAdfsResponseStrategy strategy) {
         ...
         */
        @java.lang.Override
        public _FinalStage options(IdpAdfsOptionsResponse options) {
        ...
        public _FinalStage options(Optional<IdpAdfsOptionsResponse> options) {
            this.options = options;
            return this;
        }

        @java.lang.Override
        public IdpAdfsResponse build() {
            return new IdpAdfsResponse(
                    strategy,
                    options,
                    id,
                    name,
