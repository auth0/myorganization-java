...
@JsonDeserialize(builder = IdpSamlpRequest.Builder.class)
public final class IdpSamlpRequest {
    private final IdpSamlpRequestStrategy strategy;

    private final IdpSamlpOptionsRequest options;
    ...
    private IdpSamlpRequest(
            IdpSamlpRequestStrategy strategy,
            IdpSamlpOptionsRequest options,
            Optional<String> id,
            String name,
    ...
    public IdpSamlpRequestStrategy getStrategy() {
        return strategy;
    }
    ...
    public IdpSamlpOptionsRequest getOptions() {
        return options;
    }
    ...
    private boolean equalTo(IdpSamlpRequest other) {
    ...
    public interface StrategyStage {
        OptionsStage strategy(@NotNull IdpSamlpRequestStrategy strategy);

        Builder from(IdpSamlpRequest other);
    }
    ...
    public interface OptionsStage {
         ...
         */
        NameStage options(@NotNull IdpSamlpOptionsRequest options);
    }
    ...
    public static final class Builder implements StrategyStage, OptionsStage, NameStage, _FinalStage {
        private IdpSamlpRequestStrategy strategy;

        private IdpSamlpOptionsRequest options;
