...
@JsonDeserialize(builder = IdpAdfsRequest.Builder.class)
public final class IdpAdfsRequest {
    private final IdpAdfsRequestStrategy strategy;

    private final IdpAdfsOptionsRequest options;
    ...
    private IdpAdfsRequest(
            IdpAdfsRequestStrategy strategy,
            IdpAdfsOptionsRequest options,
            Optional<String> id,
            String name,
    ...
    public IdpAdfsRequestStrategy getStrategy() {
        return strategy;
    }
    ...
    public IdpAdfsOptionsRequest getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpAdfsRequest && equalTo((IdpAdfsRequest) other);
    }
    ...
    private boolean equalTo(IdpAdfsRequest other) {
    ...
    public interface StrategyStage {
        OptionsStage strategy(@NotNull IdpAdfsRequestStrategy strategy);

        Builder from(IdpAdfsRequest other);
    }
    ...
    public interface OptionsStage {
         ...
         */
        NameStage options(@NotNull IdpAdfsOptionsRequest options);
    }
    ...
    public static final class Builder implements StrategyStage, OptionsStage, NameStage, _FinalStage {
        private IdpAdfsRequestStrategy strategy;

        private IdpAdfsOptionsRequest options;
        ...
        @java.lang.Override
        public Builder from(IdpAdfsRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public OptionsStage strategy(@NotNull IdpAdfsRequestStrategy strategy) {
        ...
        @java.lang.Override
        @JsonSetter("options")
        public NameStage options(@NotNull IdpAdfsOptionsRequest options) {
        ...
        @java.lang.Override
        public IdpAdfsRequest build() {
            return new IdpAdfsRequest(
                    strategy,
                    options,
                    id,
                    name,
