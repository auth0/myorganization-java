...
@JsonDeserialize(builder = IdpSamlpUpdateRequest.Builder.class)
public final class IdpSamlpUpdateRequest implements IIdpUpdateBase {
    ...
    private final Optional<IdpSamlpOptionsRequest> options;

    private final Map<String, Object> additionalProperties;

    private IdpSamlpUpdateRequest(
            Optional<String> displayName,
            Optional<Boolean> showAsButton,
            Optional<Boolean> assignMembershipOnLogin,
            Optional<Boolean> isEnabled,
            Optional<IdpSamlpOptionsRequest> options,
    ...
    public Optional<IdpSamlpOptionsRequest> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpSamlpUpdateRequest && equalTo((IdpSamlpUpdateRequest) other);
    }
    ...
    private boolean equalTo(IdpSamlpUpdateRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<IdpSamlpOptionsRequest> options = Optional.empty();
        ...
        public Builder from(IdpSamlpUpdateRequest other) {
        ...
        public Builder options(Optional<IdpSamlpOptionsRequest> options) {
            this.options = options;
            return this;
        }

        public Builder options(IdpSamlpOptionsRequest options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public IdpSamlpUpdateRequest build() {
            return new IdpSamlpUpdateRequest(
