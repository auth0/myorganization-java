...
@JsonDeserialize(builder = IdpScimTokenBase.Builder.class)
public final class IdpScimTokenBase implements IIdpScimTokenBase {
    ...
    private boolean equalTo(IdpScimTokenBase other) {
    ...
    public interface TokenIdStage {
        ...
        Builder from(IdpScimTokenBase other);
    }
    ...
    public static final class Builder implements TokenIdStage, CreatedAtStage, _FinalStage {
