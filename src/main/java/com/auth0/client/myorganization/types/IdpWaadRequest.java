...
@JsonDeserialize(builder = IdpWaadRequest.Builder.class)
public final class IdpWaadRequest {
    private final IdpWaadRequestStrategy strategy;

    private final IdpWaadOptionsRequest options;
    ...
    private IdpWaadRequest(
            IdpWaadRequestStrategy strategy,
            IdpWaadOptionsRequest options,
            Optional<String> id,
            String name,
    ...
    public IdpWaadRequestStrategy getStrategy() {
        return strategy;
    }
    ...
    public IdpWaadOptionsRequest getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IdpWaadRequest && equalTo((IdpWaadRequest) other);
    }
    ...
    private boolean equalTo(IdpWaadRequest other) {
    ...
    public interface StrategyStage {
        OptionsStage strategy(@NotNull IdpWaadRequestStrategy strategy);

        Builder from(IdpWaadRequest other);
    }
    ...
    public interface OptionsStage {
         ...
         */
        NameStage options(@NotNull IdpWaadOptionsRequest options);
    }
    ...
    public static final class Builder implements StrategyStage, OptionsStage, NameStage, _FinalStage {
        private IdpWaadRequestStrategy strategy;

        private IdpWaadOptionsRequest options;
        ...
        @java.lang.Override
        public Builder from(IdpWaadRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public OptionsStage strategy(@NotNull IdpWaadRequestStrategy strategy) {
        ...
        @java.lang.Override
        @JsonSetter("options")
        public NameStage options(@NotNull IdpWaadOptionsRequest options) {
        ...
        @java.lang.Override
        public IdpWaadRequest build() {
            return new IdpWaadRequest(
                    strategy,
                    options,
                    id,
                    name,
