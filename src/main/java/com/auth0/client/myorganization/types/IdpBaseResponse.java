...
@JsonDeserialize(builder = IdpBaseResponse.Builder.class)
public final class IdpBaseResponse {
    ...
    private boolean equalTo(IdpBaseResponse other) {
    ...
    public interface StrategyStage {
        ...
        Builder from(IdpBaseResponse other);
    }

    public interface _FinalStage {
        IdpBaseResponse build();
