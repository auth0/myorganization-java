...
public final class IdpWaadResponse {
    ...
    private final IdpWaadOptionsResponse options;
    ...
    private IdpWaadResponse(
            ...
            IdpWaadOptionsResponse options,
            Optional<String> id,
    ...
    public IdpWaadOptionsResponse getOptions() {
        return options;
    }
    ...
    public interface StrategyStage {
        OptionsStage strategy(@NotNull IdpWaadResponseStrategy strategy);
    ...
    public interface OptionsStage {
         ...
         */
        _FinalStage options(@NotNull IdpWaadOptionsResponse options);
    }
    ...
    public static final class Builder implements StrategyStage, OptionsStage, _FinalStage {
        ...
        private IdpWaadOptionsResponse options;
        ...
        @Override
        @JsonSetter("strategy")
        public OptionsStage strategy(@NotNull IdpWaadResponseStrategy strategy) {
        ...
        @Override
        @JsonSetter("options")
        public _FinalStage options(@NotNull IdpWaadOptionsResponse options) {
