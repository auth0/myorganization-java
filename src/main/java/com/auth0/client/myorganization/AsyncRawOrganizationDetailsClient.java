...
public class AsyncRawOrganizationDetailsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawOrganizationDetailsClient(ClientOptions clientOptions) {
     ...
     * Retrieve details for this Organization, including display name and branding options. To learn more about Auth0 Organizations, read <a href="https://auth0.com/docs/manage-users/organizations">Organizations</a>.
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<OrgDetailsRead>> get(RequestOptions requestOptions) {
        ...
        CompletableFuture<MyOrganizationApiHttpResponse<OrgDetailsRead>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MyOrganizationApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, OrgDetailsRead.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<OrgDetailsRead>> update() {
        return update(OrgDetails.builder().build());
    }

    /**
     * Update details for this Organization, such as display name and branding options. To learn more about Auth0 Organizations, read <a href="https://auth0.com/docs/manage-users/organizations">Organizations</a>.
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<OrgDetailsRead>> update(RequestOptions requestOptions) {
        return update(OrgDetails.builder().build(), requestOptions);
    }

    /**
     * Update details for this Organization, such as display name and branding options. To learn more about Auth0 Organizations, read <a href="https://auth0.com/docs/manage-users/organizations">Organizations</a>.
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<OrgDetailsRead>> update(OrgDetails request) {
     ...
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<OrgDetailsRead>> update(
            OrgDetails request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("details");
        if (requestOptions != null) {
