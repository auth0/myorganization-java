...
public class AsyncRawUserStoresClient {
    protected final ClientOptions clientOptions;

    public AsyncRawUserStoresClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<ListUserStoresResponseContent>> list() {
    ...
    public CompletableFuture<MyOrganizationApiHttpResponse<ListUserStoresResponseContent>> list(
        ...
        CompletableFuture<MyOrganizationApiHttpResponse<ListUserStoresResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MyOrganizationApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ListUserStoresResponseContent.class),
                                response));
                        return;
                    }
                    try {
