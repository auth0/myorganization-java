...
public class RawRolesClient {
     ...
     */
    public MyOrganizationApiHttpResponse<GetMemberInvitationRolesResponseContent> list(String invitationId) {
     ...
     * Retrieve the roles assigned to a member invitation specified by ID for this Organization.
     */
    public MyOrganizationApiHttpResponse<GetMemberInvitationRolesResponseContent> list(
