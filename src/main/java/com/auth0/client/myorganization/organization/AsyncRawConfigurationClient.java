...
public class AsyncRawConfigurationClient {
    protected final ClientOptions clientOptions;

    public AsyncRawConfigurationClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<GetConfigurationResponseContent>> get() {
        return get(null);
    }
    ...
    public CompletableFuture<MyOrganizationApiHttpResponse<GetConfigurationResponseContent>> get(
        ...
        CompletableFuture<MyOrganizationApiHttpResponse<GetConfigurationResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MyOrganizationApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetConfigurationResponseContent.class),
                                response));
                        return;
                    }
                    try {
