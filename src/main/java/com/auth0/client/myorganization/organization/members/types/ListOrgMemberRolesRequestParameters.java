 ...
 */
package com.auth0.client.myorganization.organization.members.types;
...
@JsonDeserialize(builder = ListOrgMemberRolesRequestParameters.Builder.class)
public final class ListOrgMemberRolesRequestParameters {
    ...
    private ListOrgMemberRolesRequestParameters(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListOrgMemberRolesRequestParameters
                && equalTo((ListOrgMemberRolesRequestParameters) other);
    }
    ...
    private boolean equalTo(ListOrgMemberRolesRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListOrgMemberRolesRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
            return this;
        }
        ...
        public ListOrgMemberRolesRequestParameters build() {
            return new ListOrgMemberRolesRequestParameters(from, take, additionalProperties);
        }
