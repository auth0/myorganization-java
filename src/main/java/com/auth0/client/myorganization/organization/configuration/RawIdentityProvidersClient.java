...
public class RawIdentityProvidersClient {
     ...
     */
    public MyOrganizationApiHttpResponse<IdentityProvidersConfig> get() {
        return get(null);
    }
     ...
     * Retrieve the <a href="https://auth0.com/docs/authenticate/enterprise-connections/connection-profile">Connection Profile</a> for this application. You should cache this information as it does not change frequently.
     */
    public MyOrganizationApiHttpResponse<IdentityProvidersConfig> get(RequestOptions requestOptions) {
