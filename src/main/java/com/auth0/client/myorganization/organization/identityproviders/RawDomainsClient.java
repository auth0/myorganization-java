...
public class RawDomainsClient {
     ...
     */
    public MyOrganizationApiHttpResponse<CreateIdpDomainResponseContent> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MyOrganizationApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateIdpDomainResponseContent.class),
                        response);
            }
            try {
     ...
     */
    public MyOrganizationApiHttpResponse<Void> delete(String idpId, String domain) {
     ...
     * Remove a domain specified by name from an Identity Provider specified by ID for this Organization.
     */
    public MyOrganizationApiHttpResponse<Void> delete(String idpId, String domain, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("identity-providers")
                .addPathSegment(idpId)
