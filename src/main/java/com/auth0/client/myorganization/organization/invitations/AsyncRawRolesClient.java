...
public class AsyncRawRolesClient {
     ...
     */
    public CompletableFuture<MyOrganizationApiHttpResponse<GetMemberInvitationRolesResponseContent>> list(
            String invitationId) {
        return list(invitationId, null);
    }
    ...
    public CompletableFuture<MyOrganizationApiHttpResponse<GetMemberInvitationRolesResponseContent>> list(
        ...
        CompletableFuture<MyOrganizationApiHttpResponse<GetMemberInvitationRolesResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MyOrganizationApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetMemberInvitationRolesResponseContent.class),
                                response));
                        return;
                    }
                    try {
